...
export const metadata: Metadata = {
  title: "Webmines – Scaling D2C with Technology",
  description:
    "Webmines is a technology company building proprietary performance systems and software for D2C brand growth. Scale profitably with our data-driven tech and performance infrastructure.",
  keywords:
    "Webmines, e-commerce software, growth technology, performance marketing systems, D2C growth tech, ad management software, performance infrastructure, e-commerce data systems",
  robots: "index, follow",
  openGraph: {
    type: "website",
    title: "Webmines – Scaling D2C with Technology",
  ...
  twitter: {
    ...
    title: "Webmines – E-Commerce Technology & Growth",
    description:
      "Proprietary tech-driven performance systems for modern D2C brands. Built for profitability and scale.",
    images: ["https://i.postimg.cc/3wWLDB2q/Instagram-story-16.png"],
  },
  icons: {
    icon: "/Webmines/favicon.ico",
    apple: "/Webmines/apple-touch-icon.png",
  },
  manifest: "/Webmines/site.webmanifest",
};
