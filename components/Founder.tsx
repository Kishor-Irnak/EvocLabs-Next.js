            ...
            >
              <div className="flex flex-col items-center lg:items-start space-y-6 text-center lg:text-left">
                ...
                >
                  <Badge
                    variant="secondary"
                    className="gap-2 bg-blue-500/10 border-blue-500/20 text-blue-400 text-xs font-mono uppercase tracking-wider"
                  >
              ...
              <div className="relative pl-6 md:pl-8 border-l-2 border-white/10 my-6 text-left">
                ...
                <p className="text-xl md:text-2xl text-text-muted italic leading-relaxed font-light">
                  "It's about aligning your product with a{" "}
                  <span className="text-white font-medium not-italic">
                    performance culture
                  </span>
                  . At Evoc Labs, we treat your budget like our own capital."
                </p>
              </div>
              ...
              <div className="pt-6 flex flex-col sm:flex-row gap-8 items-center lg:justify-start">
                <Button
                  ...
                  variant="default"
                  size="lg"
                  className="group relative flex items-center justify-center gap-3 px-8 py-3.5 rounded-xl bg-white text-black font-semibold text-sm hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:scale-[1.02] transition-all duration-300 w-full sm:w-auto hover:bg-white"
                >
                  <a
