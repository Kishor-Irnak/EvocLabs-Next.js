...
import { SiDiscord, SiSlack, SiZendesk, SiIntercom, SiJira } from "react-icons/si";
import { Layers, Book, Sparkles, Settings, FileText, Database, User } from "lucide-react";

const ConnectedKnowledge = () => {
  return (
    <section className="bg-[#050505] py-20 lg:py-32 relative overflow-hidden border-b border-white/5">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="flex flex-col xl:flex-row items-center gap-16 xl:gap-8">
          ...
          <div className="w-full xl:w-5/12 flex flex-col justify-center text-center xl:text-left">
            <div className="text-[#3b82f6] text-sm font-bold tracking-wider uppercase mb-5">
              CONNECTED KNOWLEDGE
            </div>
            <h2 className="text-[32px] md:text-[40px] lg:text-[46px] leading-[1.1] font-medium text-white mb-6 tracking-tight">
              A connected layer for product knowledge
            </h2>
            <p className="text-[17px] text-[#8b8b8f] leading-[1.6] max-w-[480px] mx-auto xl:mx-0 font-light">
            ...
            <div className="relative aspect-square md:aspect-4/3 w-full max-w-[800px] mx-auto bg-[#0c0c0c] rounded-3xl border border-white/10 overflow-hidden shadow-[0_0_80px_rgba(0,0,0,0.8)] flex items-center justify-center">
              ...
              >
                ...
                <svg className="absolute inset-0 w-full h-full pointer-events-none z-0" viewBox="0 0 800 600">
                  <defs>
                    <marker id="arrow-primary" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="4" markerHeight="4" orient="auto">
                  ...
                  <path 
                    ...
                    fill="none" stroke="#3b82f6" strokeWidth="2" strokeDasharray="4 4" strokeOpacity="0.5" markerEnd="url(#arrow-primary)" 
                  />
                  <path 
                  ...
                  <path 
                    ...
                    fill="none" stroke="#3b82f6" strokeWidth="2" strokeDasharray="4 4" strokeOpacity="0.6" markerEnd="url(#arrow-primary)" 
                  />
                  <path 
                    d="M 460 342 L 460 396" 
                    fill="none" stroke="#444" strokeWidth="2" strokeDasharray="4 4" markerEnd="url(#arrow-gray)" 
                  />

                  {/* Sparkle horizontal connections (Gray dashed) */}
                  <path d="M 104 480 Q 170 480 240 480" fill="none" stroke="#444" strokeWidth="2" strokeDasharray="4 6" />
                  <path d="M 720 480 Q 645 480 570 480" fill="none" stroke="#444" strokeWidth="2" strokeDasharray="4 6" />
                </svg>

                {/* 1. Apps Box */}
                <div className="absolute top-[120px] left-[140px] w-[240px] h-[60px] bg-[#1a1a1a] rounded-[16px] border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.8)] flex items-center justify-between px-5 z-10">
                  <SiDiscord className="text-[#5865F2] w-6 h-6 hover:scale-110 transition-transform cursor-pointer" />
                  <div className="w-7 h-7 bg-[#3b82f6]/20 rounded-[8px] flex items-center justify-center border border-[#3b82f6]/30 hover:scale-110 transition-transform cursor-pointer">
                ...
                <div className="absolute top-[120px] left-[440px] w-[200px] h-[60px] bg-[#1a1a1a] rounded-[16px] border border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.8)] flex items-center justify-center px-4 z-10">
                  <div className="flex -space-x-4">
                    {[1, 2, 3, 4, 5].map((idx) => (
                      <div key={idx} className="w-10 h-10 rounded-full border-[3px] border-[#1a1a1a] overflow-hidden bg-[#2a2a2a] flex items-center justify-center hover:z-20 hover:scale-110 transition-all cursor-pointer shadow-sm relative">
                        <img 
