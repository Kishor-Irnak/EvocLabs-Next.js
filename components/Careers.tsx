    ...
    <div className="min-h-screen bg-background pt-24 pb-20 px-4 md:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <Button
          variant="ghost"
          asChild
          className="flex items-center gap-2 text-text-secondary hover:text-primary transition-colors mb-8 group p-0"
        >
          <Link href="/">
            <ArrowLeft
              size={20}
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            ...
            <div className="md:col-span-6 relative">
              ...
              <Input
                ...
                className="w-full bg-surface border-border rounded-lg py-6 pl-10 pr-4 text-text-main focus:outline-none focus:border-primary/50 transition-colors placeholder:text-text-muted/50"
              />
            </div>

            {/* Department Dropdown (Visual only) */}
            <div className="md:col-span-3 relative">
              <div className="w-full h-full bg-surface border border-border rounded-lg py-3 px-4 text-text-muted flex items-center justify-between cursor-pointer hover:border-white/20 transition-colors">
        ...
        <div className="space-y-4">
          {filteredJobs.map((job) => (
            ...
            >
              ...
              <div>
                <Button className="w-full md:w-auto px-8 py-6 bg-primary text-white font-medium rounded-lg hover:bg-primary-hover transition-colors shadow-lg shadow-blue-500/20">
                  View
                </Button>
              </div>
            </motion.div>
