    ...
    <section className="relative pt-20 pb-8 md:pt-36 md:pb-32 overflow-hidden bg-background min-h-screen flex flex-col items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10 flex flex-col items-center text-center w-full">
        ...
        >
          <Badge
            variant="outline"
            className="gap-2 px-4 py-1.5 bg-surface/80 border-border text-text-secondary hover:border-primary/30 transition-colors backdrop-blur-sm"
          >
        ...
        >
          ...
          <Button
            asChild
            size="lg"
            className="group relative px-8 py-6 rounded-lg bg-white text-background font-semibold text-base overflow-hidden w-full sm:w-auto hover:bg-white/90 transition-all duration-300 shadow-[0_0_20px_rgba(255,255,255,0.2)]"
          >
            <Link href="/book-demo">
              Book a demo
              <ArrowRight
